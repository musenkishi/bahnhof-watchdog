...
# Outage check
POSTAL_CODE="12345"
OUTAGE_KEYWORDS="Uppsala, Drottningsgatan, Centralstationen" # comma separated keywords to look for in the outage (case insensitive). Leave empty to disable keyword filtering.
